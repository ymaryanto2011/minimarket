@extends("layouts.app")
@section("title", "Setting Profil Toko")
@section("page_title", "Setting")
@section("page_subtitle", "Konfigurasi profil toko")
...
<form method="POST" action="{{ route("setting.profileUpdate") }}"
    x-data="{
        banks: {{ json_encode(old('bank_accounts', $store->bank_accounts ?? []) ?: []) }},
        addBank() {
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $store->name) }}" class="input-field" required>
                </div>
                <div>
            ...
            <div>
                ...
                <textarea name="address" rows="2" class="input-field">{{ old("address", $store->address) }}</textarea>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $store->email) }}" class="input-field">
                </div>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route("setting.profileUpdate") }}">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="address" rows="3" class="input-field">{{ old("address", $store->address) }}</textarea>
            </div>
            <div>
