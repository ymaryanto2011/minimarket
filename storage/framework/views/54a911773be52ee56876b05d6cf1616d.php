...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/icon-192x192.svg')); ?>">
        ...
        <aside id="app-sidebar"
            ...
            <div class="flex items-center border-b border-gray-800 h-16 px-3 gap-2">
                <div class="flex items-center gap-2 flex-1 min-w-0">
                    ...
                    <div x-show="!sidebarCollapsed" class="min-w-0">
                        ...
                        <p class="text-gray-400 text-xs whitespace-nowrap truncate"><?php echo e(env('STORE_NAME', 'Minimarket')); ?></p>
                    </div>
                </div>
            ...
            <nav class="py-4 px-2 space-y-0.5">
                ...
                <a href="<?php echo e(route('pos.index')); ?>"
                    :class="sidebarCollapsed ? 'justify-center px-2' : 'px-3'"
                    class="nav-link group relative flex items-center py-2.5 rounded-lg <?php if(request()->routeIs('pos.*')): ?> bg-blue-600 text-white <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                ...
                <a href="<?php echo e(route('quotation.index')); ?>"
                    :class="sidebarCollapsed ? 'justify-center px-2' : 'px-3'"
                    class="nav-link group relative flex items-center py-2.5 rounded-lg <?php if(request()->routeIs('quotation.*')): ?> bg-blue-600 text-white <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('report.index')); ?>"
                    :class="sidebarCollapsed ? 'justify-center px-2' : 'px-3'"
                    class="nav-link group relative flex items-center py-2.5 rounded-lg <?php if(request()->routeIs('report.*')): ?> bg-blue-600 text-white <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('barcode.index')); ?>"
                    :class="sidebarCollapsed ? 'justify-center px-2' : 'px-3'"
                    class="nav-link group relative flex items-center py-2.5 rounded-lg <?php if(request()->routeIs('barcode.*')): ?> bg-blue-600 text-white <?php endif; ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
</html><?php /**PATH D:\xampp\htdocs\Minimarket\resources\views/layouts/app.blade.php ENDPATH**/ ?>