...
<?php $__env->startSection('title', 'Penawaran Barang'); ?>
<?php $__env->startSection('page_title', 'Penawaran Barang'); ?>
<?php $__env->startSection('page_subtitle', 'Buat dan kelola penawaran harga untuk customer'); ?>

<?php $__env->startSection('content'); ?>
<script>
    window.__quotations = <?php echo json_encode($quotations->map(function($q) {
        return [
            'id' => $q->id,
    ...
    window.__products = <?php echo json_encode($products->map(fn($p) => [
        'id'           => $p->id,
        'code'         => $p->code,
        'name'         => $p->name,
    ...
    window.__store = <?php echo json_encode($store ? [
        'name' => $store->name,
    ...
    window.__nextNo = <?php echo json_encode($nextNo, 15, 512) ?>;
    window.__csrfToken = <?php echo json_encode(csrf_token(), 15, 512) ?>;
    window.__routeStore = <?php echo json_encode(route('quotation.store'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Minimarket\resources\views/quotation/index.blade.php ENDPATH**/ ?>