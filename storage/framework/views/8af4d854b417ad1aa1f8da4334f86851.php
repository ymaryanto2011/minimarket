...
<?php $__env->startSection('page_title', 'Kasir POS'); ?>
<?php $__env->startSection('page_subtitle', 'Transaksi Penjualan Real-time'); ?>
        ...
        <div class="flex flex-col bg-gray-50" style="width:35%; min-width:260px">
            ...
            <div class="px-4 py-2.5 border-b bg-white flex-shrink-0">
                ...
                <p class="text-xs text-gray-400 mt-0.5">
                    Kasir: <strong class="text-gray-600"><?php echo e($storeProfile->name ?? config('app.name')); ?></strong>
                </p>
            </div>
...
<div id="receipt-wrap" class="hidden">
    <div id="receipt">
        <div style="text-align:center;border-bottom:2px dashed #000;padding-bottom:6px;margin-bottom:6px">
            <strong id="r-store-name" style="font-size:14px"><?php echo e($storeProfile->name ?? config('app.name')); ?></strong><br>
            <span id="r-store-addr"><?php echo e($storeProfile->address ?? ''); ?></span><br>
            <span id="r-store-phone"><?php echo e(($storeProfile->phone ?? '') ? 'Telp: '.($storeProfile->phone ?? '') : ''); ?></span>
        </div>
        <table style="width:100%;font-size:11px;margin-bottom:6px">
            ...
            <tr>
                <td>Kasir</td>
                <td style="text-align:right"><?php echo e(auth()->user()->name ?? 'Admin'); ?></td>
            </tr>
        </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Minimarket\resources\views/pos/index.blade.php ENDPATH**/ ?>